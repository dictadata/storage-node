...
- version 0.9.96
  - updated: @dictadata/storage-junctions@0.9.122
  - updated: @dictadata/storage-tracts@0.9.95
- version 0.9.95
...
- version 0.9.93
  ...
  - updated: @dictadata/storage-tracts@0.9.94
- version 0.9.92
...
- version 0.9.72
  ...
  - refactor: revamp Engrams API for engrams, tracts
- version 0.9.71
...
- version 0.9.62
  ...
  - refactor: refactor StorageResults properties
  - bug fix: CSVReader, JSONReader destroy stream on error or count > max
- version 0.9.61
...
- version 2.5.0
  - stable build of engrams, smt_urn, auth_stash
