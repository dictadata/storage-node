...
async function login(req, res) {
  ...
  try {
    ...
    // found account record, check password
    ...
    results = await junction.store(account,{userid: userid});
    results["account"] = account.package();
...
async function register(req, res) {
  ...
  try {
    ...
    results["account"] = newAccount.package();
...
async function store(req, res) {
  ...
  try {
    ...
    results["account"] = modAccount.package();
