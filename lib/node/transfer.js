...
router.post('/transfer', authorize([roles.User, roles.Admin]), transfer);
...
async function transfer(req, res) {
  ...
  var j1 = storage.activate(config.smt[source.smt], source.options);
  var j2 = storage.activate(config.smt[destination.smt], destination.options);
