...
if (process.env.NODE_ENV === 'development') {
  ...
  config.smt.oracle_foo_schema    = "oracle|connectString=localhost/xepdb1;user=dicta;password=data|foo_schema|*";
  config.smt.oracle_foo_schema_pk = "oracle|connectString=localhost/xepdb1;user=dicta;password=data|foo_schema|=Foo";

  config.smt.oracle_foo_transfer  = "oracle|connectString=localhost/xepdb1;user=dicta;password=data|foo_transfer|=Foo";
  config.smt.oracle_foo_transform = "oracle|connectString=localhost/xepdb1;user=dicta;password=data|foo_transform|=Foo";
  ...
  config.smt["oracle_weather_forecast"] = "oracle|connectString=localhost/xepdb1;user=dicta;password=data|weather_forecast|*";
}
