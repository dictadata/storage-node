...
var config = {
  ...
  smt: {
    ...
    //$_accounts: 'mssql|server=localhost;username=dicta;password=data;database=storage_node|api_accounts|=userid',
...
if (process.env.NODE_ENV === 'development') {
  ...
  config.smt.$_accounts = 'mssql|server=localhost;username=dicta;password=data;database=storage_node|api_accounts|=userid';
  config.smt.accounts = 'mssql|server=localhost;username=dicta;password=data;database=storage_node|api_accounts|=userid';
